...
class SourceTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.new_source = NewsSource('Python Must Be Crazy','A thrilling new Python Series','https://newsapi.org/v2/sources?apiKey=63a6e13ee20244429ff2fa72529d69c5',"8.5,129993")
    ...
    def test_init(self):
        ...
        self.assertEqual(self.new_source.description,'https://newsapi.org/v2/sources?apiKey=63a6e13ee20244429ff2fa72529d69c5')
